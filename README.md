...
```
cd existing_repo
git remote add origin https://gitlab.ewi.tudelft.nl/cgv/cs4365/student-workspace.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.ewi.tudelft.nl/cgv/cs4365/student-workspace/-/settings/integrations)
